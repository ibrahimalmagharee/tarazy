    ...
    <div class="row">
        <div class="col-md-6 col-sm-12">
            <div class="container">
                ...
                <form method="post" action="{{route('check.vendor.login')}}" class="form justify-content-center px-5 mx-5 reg-form-custom" _lpchecked="1">
                    @csrf
                    <div class="row">
                        <div role="group" class="form-group  col-md-12 col-sm-12">
                            <input name="email" id="email"  type="email" class="form-control focus">
                    ...
                    <div class="row">
                        <div role="group" class="form-group  col-md-12 col-sm-12">
                            <input name="password" id="password" type="password" class="form-control focus">
                ...
                <div class="container ">
                    ...
                    <div class="row mx-5 px-4 justify-content-center">
                        ...
                        <i class="icon-custom fa fa-google px-3"></i>
                        <i class="icon-custom fa fa-facebook-f px-3"></i>
                    </div>
